...
// #5
   ...
   describe("member user who is not the owner of other comments performing CRUD actions for Comment", () => {
        ...
        describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
          ...
          it("should NOT delete the comment that is not owned by this member", (done) => {
            Comment.all()
            .then((comments) => {
              const commentCountBeforeDelete = comments.length;
